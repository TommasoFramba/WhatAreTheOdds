 ...
 */
public class MyOrigView extends View {
    ...
    public MyOrigView(Context context) {
        super(context);
        init(null, 0);
    }

    public MyOrigView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public MyOrigView(Context context, AttributeSet attrs, int defStyle) {
